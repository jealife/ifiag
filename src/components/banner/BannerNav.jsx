    ...
    return (
        <div className='w-full px-3 py-2  bg-[#F17E3A] flex justify-between text-slate-50'>
            <div className="gap-2 flex text-sm lg:text-xs items-center justify-center ">
                ...
                <div className=" ">
                    <Link className='flex gap-1 items-center' href="'tel:+212 522-31649"> <FiMapPin />  <span className='lg:block hidden'>Tour des Habous, 50 Avenue des FAR – 1er étage Face a l’hôtel Sheraton, Casablanca</span></Link>
                </div>
                <span class="inline-block h-full min-h-full w-px self-stretch bg-white "></span>
                <div className=" ">
